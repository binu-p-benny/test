  ...
  <div class="modal-dialog modal-lg" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
          ...
          <!-- form start -->
          <form role="form" method="POST" action="{{ url('admin/add-holiday') }}">
            @csrf
            <div class="card-body">
              <div class="row">
              <div class="col-6">
                <div class="form-group">
                  ...
                  <input type="text" name="holiday_title" class="form-control" id="exampleInputEmail1" placeholder="Title">
                </div>
              </div>
              <div class="col-6">
                <div class="form-group">
                  <label for="exampleInputEmail1">Holiday Date</label>
                  <input type="date" name="holiday_date" class="form-control" id="exampleInputEmail1" placeholder="">
                </div>
              </div>
            </div>
          </div>
                      ...
                      <tbody>
                          ...
                          <tr>
                            ...
                            <td> 
                                ...
                                <a href="{{ url('/admin/remove-holiday/'.$item->id)}}" class="btn btn-app">
